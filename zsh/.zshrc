...
#==========================================================================
# API KEYS AND ACCESS
export FAR_STAGE_API_KEY=03a07cd1a2523fa1d0b9b8b06b162f89849c6017
export FAR_PROD_API_KEY=fc15d436013b7236f76b5d05bfcaebe0eed33d85
export FAR_PROMO_ACCESS=access
export FAR_PROMO_TOKEN

export IMA_API_TOKEN=4KiCASv7nnQQpe3cqxF3g2SwvZuM9xjD

export IPEG_ACCESS_CODE=dev
 
# BASIC AUTH ACCESS INFORMATION
export FAR_APP_USER=svefs01t
export FAR_APP_PWD='XTKvs$H7NAg!-DS'
 
#FAR_ENV ENVIRONMENT VARIABLE FOR BUILDING CONFIG FILES
export FAR_ENV=
#==========================================================================
